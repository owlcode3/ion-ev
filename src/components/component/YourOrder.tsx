    ...
    <div className="your-order">
      <div className="your-order__box-1">
        <span className="your-order__heading">Your Order
          {
            hideOrder ? <img onClick={() => setHideOrder(!hideOrder)} className="your-order__hide-icon" src="/public/Arrow - up.svg" alt="arrow down" /> : <img onClick={() => setHideOrder(!hideOrder)} className="your-order__hide-icon" src="/public/Arrow - down.svg" alt="arrow down" />
          }
        </span>
        <span className="your-order__edit">Edit</span>
      </div>

      <div className="your-order__boxes-boxes" style={{ display: hideOrder ? "none" : "flex" }}>
